...
export default function CourseCard(props) {
  ...
  return (
    <>
      <div className="h-[400px] flex flex-col shadow-sm rounded-md">
        <img className="h-[180px] rounded-t-xl" src={avatar} />
        <div className="flex flex-col h-full gap-y-3 px-4 bg-white rounded-md">
          ...
          <input
            className="w-full h-8 bg-accent-light text-white text-md rounded-md mt-1"
            type="button"
            value="Save"
          />
        </div>
