...
export default function KeyBenefit() {
  return (
    <section className="relative z-10 flex flex-col gap-10 px-5 md:px-[60px] lg:px-[120px] ">
      <article className="flex flex-col items-center justify-center text-center gap-1">
        <span className="text-sub-title-small md:text-sub-title-medium lg:text-sub-title-large text-accent font-semibold">
          Our key benefits
        </span>
