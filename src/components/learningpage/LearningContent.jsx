          ...
          <section className="bg-[#2c3e50] text-white p-4 sm:p-6 md:p-8 rounded-md">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <button
                ...
                className="mt-3 inline-block bg-accent hover:bg-green-600 text-white text-sm sm:text-base md:text-lg py-2 px-4 md:py-3 md:px-6 rounded-md transition-colors text-center md:self-end"
              >
