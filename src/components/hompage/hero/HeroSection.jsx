...
export default function HeroSection() {
  ...
  return (
    <>
      ...
      <img
        className="hidden md:inline absolute translate-x-180 translate-y-10"
        src={"./img/elementarrow.svg"}
        alt=""
      />
      <img
        className="hidden md:inline absolute translate-x-[-700px] translate-y-[-200px]"
        src={"./img/ellipse.svg"}
        alt=""
      />
      <img
        className="hidden md:inline absolute translate-x-[800px] translate-y-[500px]"
        src={"./img/ellipse.svg"}
        alt=""
      />
      <img
        className="hidden md:inline md:absolute translate-x-[-720px] translate-y-[580px]"
